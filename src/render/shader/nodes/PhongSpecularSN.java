...
public class PhongSpecularSN extends ShaderNode {
	...
	public String getGLSL() {
		...
		sb.append("vec3 " + variable("L") + " = normalize(" + NodeBasedShader.getUBO().getUniforms().get(ShaderNodeValue.UNIFORM_LIGHT_UBO_POSITION).getName() + " - " + nbs.getInputNode().getOutWorldPosition().getName() + ");\n");
